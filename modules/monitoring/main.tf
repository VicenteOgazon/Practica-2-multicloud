...
resource "local_file" "prometheus_config" {
  ...
  filename = "/home/vicente/Escritorio/Grado Ingenieria/4 año/1 Semestre/Redes avanzadas/Practica2/modules/monitoring/${var.prometheus_container_name}-generated-prometheus.yml"
}

resource "local_file" "promtail_config" {
  content  = local.promtail_config
  filename = "/home/vicente/Escritorio/Grado Ingenieria/4 año/1 Semestre/Redes avanzadas/Practica2/modules/monitoring/${var.promtail_container_name}-generated-promtail.yml"
}
